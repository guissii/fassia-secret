          ...
          <table className="admin-table">
            ...
            <tbody>
              {order.items.map((item, index) => {
                const imageSrc = item.image && (item.image.startsWith('data:') || item.image.startsWith('http') || item.image.startsWith('blob:')) ? item.image : publicAssetUrl(item.image || 'placeholder.png');
                return (
                  <tr key={index}>
                    <td>
