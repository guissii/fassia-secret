          ...
          <div className="product-split-layout">
            ...
            <div className="product-form-side">
              ...
              <div className="form-group toggle-group" style={{ marginTop: '0.5rem' }}>
                <label className="toggle-label">
                  <div>
                    <span style={{ fontWeight: 500 }}>Nouveauté</span>
                    <p className="text-muted text-sm" style={{ margin: 0 }}>Afficher dans la section Nouveautés (max 40)</p>
                  </div>
                  <div className="switch-wrapper">
                    <input type="checkbox" name="isNew" checked={formData.isNew === true} onChange={handleChange} />
                    <span className="slider round"></span>
                  </div>
                </label>
              </div>
              ...
              <div className="form-group toggle-group" style={{ marginTop: '0.5rem' }}>
                <label className="toggle-label">
                  <div>
                    ...
                    <p className="text-muted text-sm" style={{ margin: 0 }}>Afficher dans la section Meilleures ventes (max 40)</p>
                  </div>
                  <div className="switch-wrapper">
              ...
              <div className="form-group toggle-group" style={{ marginTop: '0.5rem' }}>
                <label className="toggle-label">
                  <div>
                    ...
                    <p className="text-muted text-sm" style={{ margin: 0 }}>Afficher dans la section HMIZAT (max 40)</p>
                  </div>
                  <div className="switch-wrapper">
